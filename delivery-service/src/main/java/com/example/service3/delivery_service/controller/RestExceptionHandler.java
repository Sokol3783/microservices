...
import com.example.service3.delivery_service.dto.ErrorResponseDTO;
import com.example.service3.delivery_service.dto.ErrorResponseDTO.ErrorField;
...
public class RestExceptionHandler {
  ...
  private String getDetailErrorMessage(BindingResult bindingResult) {
    return switch (bindingResult.getObjectName()) {
      case "DeliveryDTO" -> "Failed to create new Delivery due to validation errors";
